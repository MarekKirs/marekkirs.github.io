...
Is the water safe to swim in? Recreational water quality is currently evaluated using microbial water-quality indicators, most commonly enterococci and *Escherichia coli*. These bacteria are normal components of the intestinal microbiota of humans and animals and, by themselves, typically do not cause illness. Instead, their presence and abundance are used as indicators of fecal contamination and potential exposure to enteric pathogens that can cause gastrointestinal illness.

However, the use of these indicators presents several important challenges in tropical environments such as Hawaiʻi. First, enterococci and *E. coli* can be naturally abundant in moist tropical soils and freshwater environments. Rainfall can wash these bacteria from soils and other surfaces into streams and, ultimately, coastal waters, resulting in elevated indicator concentrations even in the absence of recent human sewage contamination.

Second, the microorganisms that actually cause illness are not necessarily bacteria. Enteric viruses, such as noroviruses, can be important contributors to illness associated with exposure to sewage-contaminated recreational waters. Viruses differ from indicator bacteria in their environmental transport, persistence, and infectivity, meaning that indicator concentrations may not always accurately reflect pathogen-associated health risks.

Finally, conventional indicators are not source-specific. Elevated *E. coli* or enterococci concentrations can indicate fecal contamination, but they do not tell us whether that contamination originated from humans, livestock, wildlife, agricultural activities, or failing wastewater infrastructure. This makes it difficult to identify the sources of contamination and determine how best to manage them.

Our research examines conventional and alternative microbial indicators, microbial source-tracking markers, and enteric pathogens in streams and coastal waters. Our overarching goal is to help the state and other Pacific islands develop meaningful recreational water-quality standards by linking measured microbial contamination to actual risks of human illness. We use quantitative microbial risk assessment (QMRA) to evaluate relationships between pathogen concentrations, microbial indicators, and the resulting health risks.
...
```markdown
![research focus](/assets/images/what.png)
```
